...
Allows for comments with threads (through acts_as_tree) to be added to multiple and different models.
...
Install
   ...
   * To install as a gem:
    ...
    Install the gem(s):
    sudo gem install ramblex-acts_as_commentable

    add the folloowing line to your environment.rb
    config.gem 'ramblex-acts_as_commentable', :lib => 'acts_as_commentable', :source => "http://gems.github.com"
